        ...
        <main class="flex-1">
            <section class="relative h-[50vh] sm:h-[60vh] md:h-[80vh] min-h-[350px] md:min-h-[500px] flex items-center justify-center overflow-hidden">
                <div class="absolute inset-0 z-0">
                    <img class="w-full h-full object-cover object-[center_20%] md:object-center brightness-50 contrast-125" alt="Showroom Background" src="/contact_bg.jpg"/>
                        ...
                        <form @submit.prevent="submitForm" class="space-y-8">
                            ...
                            <div class="pt-6">
                                <button :disabled="isSubmitting" type="submit" 
                                    ...
                                    <span v-if="submitSuccess" class="flex items-center gap-2 text-green-700">
                                        <span class="material-symbols-outlined text-sm">check_circle</span> THÀNH CÔNG
                                    </span>
                                    <span v-if="!isSubmitting && !submitSuccess" class="material-symbols-outlined text-sm group-hover:translate-x-1 transition-transform">send</span>
                                </button>
                            </div>
                        </form>
                    </div>
