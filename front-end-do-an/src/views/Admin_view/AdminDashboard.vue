<template>
  ...
  <div v-if="isDetailModalOpen && selectedOrder" class="print:hidden fixed inset-0 z-[110] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 overflow-y-auto">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-[1200px] max-h-[90vh] overflow-hidden flex flex-col animate-fade-in">
            ...
            <div v-else class="relative w-full py-2">
              ...
              <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-6 md:gap-4 w-full">
                <div class="flex flex-col items-center text-center gap-2 flex-1">
                  <div class="w-10 h-10 rounded-full flex items-center justify-center font-bold text-xs border-2 shadow-sm transition-all bg-white z-10" :class="selectedOrder.LichSuTrangThai?.some(l => l.MaTrangThai == 1) ? '!bg-amber-500 !border-amber-500 !text-white shadow-amber-500/20' : 'border-slate-200 text-slate-400'">
                ...
                <div class="flex flex-col items-center text-center gap-2 flex-1">
                  <div class="w-10 h-10 rounded-full flex items-center justify-center font-bold text-xs border-2 shadow-sm transition-all bg-white z-10" :class="selectedOrder.LichSuTrangThai?.some(l => l.MaTrangThai == 2) ? '!bg-indigo-600 !border-indigo-600 !text-white shadow-indigo-600/20' : 'border-slate-200 text-slate-400'">
                ...
                <div class="flex flex-col items-center text-center gap-2 flex-1">
                  <div class="w-10 h-10 rounded-full flex items-center justify-center font-bold text-xs border-2 shadow-sm transition-all bg-white z-10" :class="selectedOrder.LichSuTrangThai?.some(l => l.MaTrangThai == 3) ? '!bg-sky-500 !border-sky-500 !text-white shadow-sky-500/20' : 'border-slate-200 text-slate-400'">
                ...
                <div class="flex flex-col items-center text-center gap-2 flex-1">
                  <div class="w-10 h-10 rounded-full flex items-center justify-center font-bold text-xs border-2 shadow-sm transition-all bg-white z-10" :class="selectedOrder.LichSuTrangThai?.some(l => l.MaTrangThai == 4) ? '!bg-emerald-500 !border-emerald-500 !text-white shadow-emerald-500/20' : 'border-slate-200 text-slate-400'">
