...
router.put('/fix', authMiddleware.verifyToken, donhang_userController.sua_thong_tin_don_hang_client);
router.put('/confirm-cod', authMiddleware.verifyToken, donhang_userController.xac_nhan_chon_cod);
