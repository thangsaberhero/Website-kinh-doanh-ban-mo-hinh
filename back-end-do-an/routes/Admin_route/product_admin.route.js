...
router.post('/add_cate', 
    ...
    product_Controller.them_danh_muc_moi
);
...
router.put('/quick_update_deposit/:id', authMiddleware.verifyToken, authMiddleware.verifyAdmin, product_Controller.cap_nhat_gia_coc_nhanh);
