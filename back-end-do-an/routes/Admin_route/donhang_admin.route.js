...
router.get('/get-all-ids', authMiddleware.verifyToken, authMiddleware.verifyStaff, donhang_admin_Controller.lay_tat_ca_id_don_hang);
...
router.post('/tach_don', authMiddleware.verifyToken, authMiddleware.verifyStaff, donhang_admin_Controller.tach_don_hang);
router.post('/print-bulk', authMiddleware.verifyToken, authMiddleware.verifyStaff, donhang_admin_Controller.in_hoa_don_hang_loat);
